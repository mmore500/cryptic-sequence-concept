...
# -*- coding: utf-8 -*-
#
# cryptic-sequence-concept documentation build configuration file, created by
...
project = u'Cryptic Sequence Complexity Concept'
copyright = u"2024, Matthew Andres Moreno"
...
htmlhelp_basename = 'cryptic-sequence-conceptdoc'
...
latex_documents = [
    (master_doc, 'cryptic-sequence-concept.tex',
     u'Cryptic Sequence Complexity Concept Documentation',
...
man_pages = [
    (master_doc, 'cryptic-sequence-concept',
     u'Cryptic Sequence Complexity Concept Documentation',
     [author], 1)
]
