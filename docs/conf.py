...
project = "Cryptic Sequence Complexity Concept"
...
latex_documents = [
    (
        master_doc,
        "cryptic-sequence-concept.tex",
        "Cryptic Sequence Complexity Concept Documentation",
...
if on_rtd:  # rtd doesn't run Makefile, so we have to copy assets ourself
    ...
    import sphinx_rtd_theme  # noqa: F811
