...
Effect sizes for these sites were uniformly between 0 and 0.2, relative to an effect detectability threshold of 1.0.
...
We then performed 1,000 knockouts of site sets sampled at each dosage then fit a negative binomial distribution to the observed outcome frequencies.
...
To disambiguate these scenarios, we perofrm an additional step: ``jackknife'' one-by-one knockouts of each site within sampled skeletons.
